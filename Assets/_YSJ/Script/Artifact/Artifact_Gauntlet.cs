...
public class Artifact_Gauntlet : Artifact_YSJ
{
    private void Start()
    {
        ArtifactInitialize();   
    ...
    {
        Managers.Sound.PlaySFX(Define.SFX.GauntletNormalAttack);
    }

    void PlaySkillSFX(Artifact_YSJ artifact = null, GameObject go = null)
    {
        Managers.Sound.PlaySFX(Define.SFX.GauntletSkillAttack);
    }
}