...
public class ImageParts_HitSkill_AttackPower_1 : ImagePartsRoot_YSJ, IImagePartsToSkillAttack_YSJ
{
    ...
    void StartBuff()
    {
        float addNormal = 0.15f * _fireArtifact.artifactStatus.Default_NormalAttackPower;
        float addSkill = 0.15f * _fireArtifact.artifactStatus.Default_SkillAttackPower;
        
        _fireArtifact.artifactStatus.Added_NormalAttackPower += addNormal;
        _fireArtifact.artifactStatus.Added_SkillAttackPower += addSkill;
